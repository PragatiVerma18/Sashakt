...
function Home() {
  ...
  return (
    <div>
      ...
      <StyledContainer>
        <div>
          <h1 className='mb-4 font-bold text-center text-lg sm:text-3xl text-purple-800'>
          ...
          >
            ...
            <button
              ...
              className='mx-2 bg-purple-800 hover:bg-blue-800 text-white font-bold py-1 px-4 rounded transition ease-in duration-200'
              disabled={loading}
            >
          ...
          {loading ? (
            ...
            <div>
                ...
                >
                  <div className='text-gray-800 bg-white mx-4 my-2 sm:m-2 p-6 shadow rounded'>
                    ...
                    <div className='mt-1 text-sm'>
                      ...
                      <Link
                        to={`job/${job.id}`}
                        className='block transition duration-15 ease-in-out rounded mt-1 py-1 px-2 border border-purple-800 text-center bg-purple-800 text-white hover:bg-white hover:text-purple-800'
                      >
                        See Job Details
                      </Link>
                    </div>
              ...
              <Link
                to={'/jobs'}
                style={{ width: 300 }}
                className='mx-auto mt-4 flex justify-center transition duration-15 ease-in-out rounded py-2 px-2 font-bold border border-purple-800 text-center bg-purple-800 text-white hover:bg-purple-900'
              >
                See All Jobs
              </Link>
            </div>
      ...
      <div className='shadow mt-2 bg-white p-4'>
        <h1 className='text-3xl font-bold text-center m-2 text-purple-900'>
          How Awsar works?
        </h1>
        <img
      ...
      <div className='mt-2 shadow p-4 sm:px-24 sm:py-8 bg-white'>
        <h1 className='my-2 font-bold text-center text-lg sm:text-3xl text-purple-800'>
