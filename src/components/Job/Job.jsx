  ...
  return (
    <div className='relative my-8 shadow rounded p-6 m-auto w-5/6 sm:w-1/2 bg-white'>
      <div className='sm:w-5/6'>
        <p className='text-purple-800 text-2xl font-bold text-center'>
          {job.title}
        </p>
        <div className='mt-2 text-gray-700 text-sm'>
          ...
          <p className='mt-1'>
            ...
            <Link
              ...
              className='uppercase font-bold text-purple-800 hover:underline'
            >
              {job.company_name}
            </Link>
          </p>
          {job.website && (
            <p className='mt-1'>
              ...
              <a href={job.website} className='text-purple-800 hover:underline'>
                {job.website}
              </a>
            </p>
          )}
      ...
      {user.role === 'Employee' && (
        <button
          onClick={applyToJob}
          className='mt-3 w-full rounded-sm text-white py-1 px-4 bg-purple-800 hover:bg-purple-900 border border-purple-800'
